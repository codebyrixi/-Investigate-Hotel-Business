...
| Nilai Anomali            | 1. Terdapat nilai negatif dan outlier yang sangat jauh dari distribusi data pada kolom `adr` 2. Terdapat 180 data booking yang tidak memiliki tamu | Melakukan _drop_ pada baris data tersebut                                                                                                                                                                                                                                                                                                                                                      |
